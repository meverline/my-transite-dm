...
public class Trip  implements IDocument, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return uuid == trip.uuid &&
                ...
                Objects.equals(getVersion(), trip.getVersion()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, getId(), getVersion(), service, headSign, shortName, routeTripIndex, directionId, shape, stopTimes, docId);
    }
