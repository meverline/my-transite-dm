...
public class RouteRequestEndpoint extends AbstractMarshallingPayloadEndpoint {
	...
	protected Object invokeInternal(Object arg0) throws Exception {
		RouteRequest request = RouteRequest.class.cast(arg0);
		
		return new RouteResponse(this.getRouteQueryHandler().query(request));
	}
