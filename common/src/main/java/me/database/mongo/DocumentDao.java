...
public class DocumentDao {
	...
	protected DocumentDao() throws UnknownHostException
    {
    ...
    private void translateList(Object value, String key, Object rtn) {
            ...
            for ( String key : item.keySet()) {
                ...
                if ( ! this.skipField(key) ) {
                    if ( this.isPrimativeType(value.getClass())) {
                        ...
                        this.setValue(rtn, 
                        		      key, 
                        		      this.translateToDbObject(BasicDBObject.class.cast(value)));
