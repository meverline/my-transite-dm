...
public class TransitFeedParser {
	...
	private Log log = LogFactory.getLog(TransitFeedParser.class);
	...
	private void initilize()
	{
		FileReader inStream;
		try {
			inStream = new FileReader("C:/java/Transite/common/config/ClassMap.properties");
	...
	public static void main(String[] args) {
		...
		String dir = "C:/Java/Transite/google_transit";
		//String orginization[] = { "DC_Circulator" };
		String orginization[] = { "metro", "ART", "DC_Circulator" };
