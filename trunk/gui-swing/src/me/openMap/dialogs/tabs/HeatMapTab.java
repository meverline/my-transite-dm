...
public class HeatMapTab implements SettingsParameterTab {
	...
	private JComboBox xbandWidthBox = null;
	private JComboBox ybandWidthBox = null;
	private JComboBox kernalBox = null;
	...
	public void init(JDialog parent)
	{
		...
		this.kernalBox = new JComboBox(KernalType.values());
		...
		this.xbandWidthBox = new JComboBox(BandWidthType.values());
		...
		this.ybandWidthBox = new JComboBox(BandWidthType.values());
