...
import me.utils.TransiteEnums.DistanceUnitType;
...
public class DataMining extends AbstractSearchParameters 
	...
	private JComboBox<Agency> agencyBox = null;
	private JComboBox<DataMiningType> produceBox = null;
	private JFormattedTextField  gridSize_ = null;
	private JComboBox<Integer>  percentile_;
	private JPanel samplePanel = null;
	private JComboBox<DataSample> sampleTypes = null;
	private JComboBox<DistanceUnitType> units = null;
	...
	private void build(OpenTransitMap map, List<String> sampleList) {
		...
		produceBox = new JComboBox<DataMiningType>( DataMiningType.values());
		...
		DataSample dsarray[] = new DataSample[aList.size()];
		sampleTypes = new JComboBox<DataSample>( aList.toArray(dsarray) );
		...
		units = new JComboBox<DistanceUnitType>( TransiteEnums.DistanceUnitType.values());
		inputs.add(units);
		fields.add(inputs);
		...
		percentile_ = new JComboBox<Integer>(array);
	...
	public class SampleOptionsActionListener implements ActionListener {
		...
		public SampleOptionsActionListener(OpenTransitMap panel, JComboBox<DataSample> sampleBox)
		{
