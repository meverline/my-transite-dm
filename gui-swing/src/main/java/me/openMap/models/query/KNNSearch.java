...
public class KNNSearch extends AbstractSearchParameters {
	...
	private JComboBox<String> state_;
	private JComboBox<DistanceUnitType> units_;
	private JFormattedTextField zipCode_;
	
	private JList<String> addressList_;
	...
	private void build(OpenTransitMap map) {
		...
		units_ = new JComboBox<DistanceUnitType>( TransiteEnums.DistanceUnitType.values());
		inputs.add(units_);
		fields.add(inputs);
		...
		state_ = new JComboBox<String>(twoLetterState);
