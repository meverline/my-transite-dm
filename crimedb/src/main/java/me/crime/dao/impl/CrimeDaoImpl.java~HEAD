...
public class CrimeDaoImpl extends AbstractHibernateDao<Crime> implements CrimeDao {
	 ...
	 */
	public CrimeDaoImpl() throws SQLException, ClassNotFoundException {
		super(Crime.class);
	}
	
	public CrimeDaoImpl(HibernateConnection aConnection) throws SQLException, ClassNotFoundException {
