...
public class DataSaver {
	...
	public enum DataType {
		...
		ROUTE {
			...
			public Object convert(String data) {
				...
				return dao.loadById(id, getBlackboard().getAgencyName());
			}
		...
		private Blackboard parser = null;
		...
		public void setParser(Blackboard aClass) {
			parser = aClass;
		}
	 ...
	 *            the parser to set
	 */
	protected void setBlackboard(Blackboard parser) {
		this.parser = parser;
	}
	...
	public void save(Object obj, String data) {
		try {
			...
			getType().setParser(getBlackboard());
